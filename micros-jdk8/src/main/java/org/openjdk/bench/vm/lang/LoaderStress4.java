...
public class LoaderStress4 {
    ...
    List<Class> loadedClassesPerLoader[]; // = new ConcurrentHashMap[loaders];
    String[] classNames;
    ...
    Map<Class, LinkedList<Object>> instList = new ConcurrentHashMap<>();
...
//                + "   }"
                + " "
                + newLine
                + "   public Integer get( Integer depth, List<Class> list) throws Exception { "
                + newLine
                + "       if (depth > 0) {"
                + newLine
...
//                + "         return  get11( --depth, list);"
                ...
                + " "
                + " "
                + "   public Integer get2( Integer depth, List<Class> list) throws Exception { "
                + "       if (depth > 0 ) {"
                + "         instB += (getMyId() + intFieldB" + filler + " + 1 );"
                + "         return  get3( --depth, list);"
                + newLine
                + newLine
                + "       } else {"
                + "         return  instB;"
                ...
                + " "
                + " "
                + "   public Integer get3( Integer depth, List<Class> list) throws Exception { "
                + "       if (depth > 0 ) {"
                + "         instC += ((depth % 2) + intFieldC" + filler + " );"
//                + "         return  get4( --depth, targetMethod, target);"
                + "         return  get11( --depth, list);"
                + "       } else {"
                + "         return  instC;"
                + "       }"
...
//                + " "
//                + "   public Integer get4( Integer depth, Method targetMethod, Object target) throws Exception { "
//                + "       if (depth > 0 ) {"
//                + "         instC += ((depth % 2) + intFieldD" + filler + " );"
//                + "         return  get5( --depth, targetMethod, target);"
//                + "       } else {"
//                + "         return  instD;"
//                + "       }"
//                + "   }"
...
//                + " "
//                + " "
//                + "   public Integer get5( Integer depth, Method targetMethod, Object target) throws Exception { "
//                + "       if (depth > 0 ) {"
//                + "         instC += ((depth % 2) + intFieldA" + filler + " );"
//                + "         return  get6( --depth, targetMethod, target);"
//                + "       } else {"
//                + "         return  instA;"
//                + "       }"
//                + "   }"
...
//                + " "
                + " "
//                + "   public Integer get6( Integer depth, Method targetMethod, Object target) throws Exception { "
//                + "       if (depth > 0 ) {"
//                + "         instC += ((depth % 2) + intFieldB" + filler + " );"
////                + "         return  get7( --depth);"
//                + "         return  get11( --depth, targetMethod, target);"
//                + "       } else {"
//                + "         return  instB;"
//                + "       }"
//                + "   }"
...
//                + "   }"
                ...
                + " "
                + " "
                + "   public Integer get11( Integer depth, List<Class> list) throws Exception { "
                + newLine
                ...
                + "  ThreadLocalRandom tlr = ThreadLocalRandom.current();"
                + "  int whichClass = tlr.nextInt(list.size());"
                + " "
                + "         Class c = list.get(whichClass);"
                + " "
                + "       Method targetMethod = c.getMethod(\"get\", Integer.class, List.class);"
                + " "
                + "       Object target = c.newInstance();"
                + newLine
                + "         return  (Integer) targetMethod.invoke( target, --depth, list);"
                + newLine
                + "       } else {"
                + " "
                + newLine
...
//        System.out.println("String list actual size:" + strings.size());
    ...
    private void setupLoadersAndLoadClasses() throws Exception {
        for (int cl = 0; cl < loaders; cl++) {
            ...
            loadedClassesPerLoader[cl] = new LinkedList<>();
            final List<Class> list = loadedClassesPerLoader[cl];
...
//                ConcurrentHashMap<String, Object> receivers1 = new ConcurrentHashMap<>();
                ...
                Class c = loadedClassesPerLoader[thisLoader].get(cc);
                ...
                IntStream.range(0, methodNames.length).forEach(m -> {
                    try {
                        methods[m] = c.getMethod(methodNames[m], Integer.class, List.class);
                    } catch (Exception e) {
                        System.out.println("Exception = " + e);
                        e.printStackTrace();
                        System.exit(-1);
...
//        for (int cl = 0; cl < loaders; cl++) {
    ...
    public void setupClasses() throws Exception {
        ...
        loadedClassesPerLoader = new LinkedList[loaders];
...
//        return which;
    ...
    Class chooseClass(ClassLoader cl) throws Exception {
        ...
        final List<Class> list = loadedClassesPerLoader[loaderIdx];

//        return cl.loadClass("B" + Integer.toString(whichClass).intern());
        return list.get(whichClass);
    }
    ...
    Object chooseInstance(Class c) throws Exception {
        ThreadLocalRandom tlr = ThreadLocalRandom.current();
        int whichInst = tlr.nextInt(instances / 4);
        LinkedList<Object> cInstances = instList.get(c);
        assert cInstances != null : "No insts for " + c;
        Object target = null;
        synchronized (cInstances) {
            assert cInstances.size() == instances : "cInstances size = " + instances;
            target = cInstances.get(whichInst);
        }
        ...
        if (counter == 50000) {
            ...
            synchronized (cInstances) {
                cInstances.removeFirst();
                cInstances.addLast(newInst);
            }
//        System.out.print(".");
    ...
    Integer callTheMethod(Method m, Object r, int recurseCount) throws Exception {
        ...
        return (Integer) m.invoke(r, recurseCount, list);
