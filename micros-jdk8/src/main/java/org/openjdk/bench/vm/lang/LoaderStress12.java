...
//        System.out.println("String list actual size:" + strings.size());
    ...
    private void compileSourceStrings() {
...
//                ConcurrentHashMap<String, Object> receivers1 = new ConcurrentHashMap<>();
                LinkedHashMap<String, Object> receivers1 = new LinkedHashMap<>();
    ...
    @BenchmarkMode(Mode.Throughput)
    @OutputTimeUnit(TimeUnit.MILLISECONDS)
    @Fork(value = 4, jvmArgs = {"-XX:+UseTransparentHugePages",
