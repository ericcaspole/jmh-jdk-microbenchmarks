...
//            + "       System.out.println( this.getClass().getName() + depth );"
  ...
  //
  //  Add back multiple methods that all access static and instance fields, maybe 1 per each!
  //
  ...
  BuildAndCall8.BenchLoader loader1 = new BuildAndCall8.BenchLoader();
