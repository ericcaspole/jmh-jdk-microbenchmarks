...
public class Mike01 {
  ...
  int index = 0;
  Map<Class, Method[]> methodsTable = new HashMap<>();
...
//            + "         System.out.println ( m + \" / \" + k);"
            ...
            + "   }"
            + " "
            + "   public Integer get2( Integer k) { "
//            + "         System.out.println ( m + \" / \" + k);"
            + "     return (Integer) k+ 20;"
            + "   }"
            + " "
            + "   public Integer get3( Integer k) { "
//            + "         System.out.println ( m + \" / \" + k);"
            + "     return (Integer) k+ 30;"
            + "   }"
            + " "
            + " "
            + "   public Integer get4( Integer k) { "
//            + "         System.out.println ( m + \" / \" + k);"
            + "     return (Integer) k+ 40;"
            + "   }"
            + " "
            + " "
            + "   public Integer get5( Integer k) { "
//            + "         System.out.println ( m + \" / \" + k);"
            + "     return (Integer) k+ 50;"
            + "   }"
            + " "
            + "   public Integer get6( Integer k) { "
//            + "         System.out.println ( m + \" / \" + k);"
            + "     return (Integer) k+ 60;"
            + "   }"
            + "}";
  ...
  Mike01.BenchLoader loader1 = new Mike01.BenchLoader();
  ...
  public void setupClasses() throws Exception {
    ...
    for (index = 0; index < compiledClasses.length; index++) {
      ...
      methodsTable.put((receivers1[0]).getClass(), methods);
      ...
      IntStream.range(0, 12000)/* .parallel() */.forEach(x -> {
                IntStream.range(0, methodNames.length).forEach(m -> {
                  try {
                    ...
                    Method[] mi = methodsTable.get(r.getClass());
                    mi[m].invoke(r,  5);
                  } catch (Exception e) {
                    System.out.println("Exception = " + e);
                    e.printStackTrace();
...
//        System.out.println(r + " " + r.getClass().getName());
        ...
        Method m = methodsTable.get(c)[whichM];
        assert m != null;
        Integer result = (Integer) m.invoke(r, whichM);
